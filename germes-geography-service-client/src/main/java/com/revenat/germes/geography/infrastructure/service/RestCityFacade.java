package com.revenat.germes.geography.infrastructure.service;
 ...
 */
public class RestCityFacade implements CityFacade {
    ...
    public RestCityFacade(final String baseUrl, final RestClient restClient) {
