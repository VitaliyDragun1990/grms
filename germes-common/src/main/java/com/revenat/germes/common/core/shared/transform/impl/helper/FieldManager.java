...
public class FieldManager {
    ...
    public List<Field> getAllFields(final Class<?> clazz) {
        Asserts.assertNotNull(clazz, "Class to extract fields from must be initialized");
    ...
    public Optional<Field> findFieldByName(final Class<?> clazz, final String fieldName) {
        Asserts.assertNotNull(clazz, "Class to extract fields from must be initialized");
        Asserts.assertNotNull(fieldName, "Name of the field to find should be initialized");
    ...
    public List<String> getFieldNames(final Class<?> clazz, final List<Predicate<Field>> filters) {
        Asserts.assertNotNull(clazz, "Class to get fields from must be initialized");
        Asserts.assertNotNull(filters, "filters must be initialized");
    ...
    public Object getFieldValue(final Object src, final String fieldName) {
        Asserts.assertNotNull(src, "Source object is not initialized");
        Asserts.assertNotNull(fieldName, "field name is not initialized");
        Asserts.assertNotBlank(fieldName, "field name can not be blank");
